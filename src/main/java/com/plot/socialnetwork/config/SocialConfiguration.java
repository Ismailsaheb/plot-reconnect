...
import com.plot.socialnetwork.security.SocialSignInAdapter;
import com.plot.socialnetwork.service.SocialConnectionSignUp;
...
public class SocialConfiguration implements SocialConfigurer {
	...
	private void init() {
		try {
			final String[] fieldsToMap = { "id", "about", "age_range", "birthday", "cover", "currency", "devices",
	...
	public void addConnectionFactories(ConnectionFactoryConfigurer connectionFactoryConfigurer,
		...
		if (!StringUtils.isEmpty(facebookClientId) && !StringUtils.isEmpty(facebookClientSecret)) {
			...
			final FacebookConnectionFactory facebookConnectionFactory = new FacebookConnectionFactory(facebookClientId,
		...
		if (!StringUtils.isEmpty(googleClientId) && !StringUtils.isEmpty(googleClientSecret)) {
			...
			final GoogleConnectionFactory googleConnectionFactory = new GoogleConnectionFactory(googleClientId,
					googleClientSecret);
	...
	public UsersConnectionRepository getUsersConnectionRepository(ConnectionFactoryLocator connectionFactoryLocator) {
		final InMemoryUsersConnectionRepository inMemoryUsersConnectionRepository = new InMemoryUsersConnectionRepository(
	...
	public ProviderSignInController providerSignInController(ConnectionFactoryLocator connectionFactoryLocator,
			UsersConnectionRepository usersConnectionRepository, SocialSignInAdapter socialSignInAdapter) {
		ProviderSignInController controller = new ProviderSignInController(connectionFactoryLocator,
				usersConnectionRepository, socialSignInAdapter);
		return controller;
	}
