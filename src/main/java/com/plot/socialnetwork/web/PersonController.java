...
public class PersonController {
	...
	public ResponseEntity<PersonView> getPerson(@PathVariable("id") Long id) {
	...
	@GetMapping("/friends")
	public Page<PersonView> getFriends(@ApiIgnore @CurrentProfile Person profile,
			@RequestParam(name = "searchTerm", defaultValue = "", required = false) String searchTerm,
			@PageableDefault(size = 20) Pageable pageRequest) {
		log.debug("REST request to get person's: {} friend list (searchTerm:{}, pageRequest:{})", profile, searchTerm,
				pageRequest);
	...
	@GetMapping("/friendOf")
	public Page<PersonView> getFriendOf(@ApiIgnore @CurrentProfile Person profile,
			@RequestParam(name = "searchTerm", defaultValue = "", required = false) String searchTerm,
			@PageableDefault(size = 20) Pageable pageRequest) {
		log.debug("REST request to get person's: {} friend_of list (searchTerm:{}, pageRequest:{})", profile,
	...
	public ResponseEntity<Void> addFriend(@ApiIgnore @CurrentProfile Person profile,
	...
	public ResponseEntity<Void> removeFriend(@ApiIgnore @CurrentProfile Person profile,
			@PathVariable("personId") Long id) {
